 ...
 * URL: https://www.apollotheater.org/events/
 */
...
export async function scrapeApolloTheater() {
  ...
  try {
    ...
    await page.goto("https://www.apollotheater.org/events/", {
    ...
    const result = await extractEventsFromPage(
      page,
      "Extract all visible events. For each event, get the event name, date, time, description if visible, and the event URL. Set eventLocation to 'Apollo Theater' for all events.",
      StandardEventSchema,
