...
// Read the JSON file
const jsonData = JSON.parse(fs.readFileSync('msg_calendar_events.json', 'utf8'));
...
// Write to CSV file
fs.writeFileSync('msg_calendar_events.csv', csvContent);

console.log(`✅ Successfully converted ${events.length} events to CSV format`);
console.log(`📁 CSV file saved as: msg_calendar_events.csv`);
console.log(`\n📊 Summary:`);
